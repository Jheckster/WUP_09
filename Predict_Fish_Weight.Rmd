...
The data for the Adjusted Squared has a best model for Lenght1. We can determine this summary has a p-value of 2.2e-16.
...
Using the above chart, we can see that the best two regressor models are Height and Width. This model is the best for the Perch data, as well as for the two element model. 
...
This chart's best model is the L1-L2-L3, Height and Weight measurement. This has an estimated Adjusted R Squared is 0.9794.
...
In this case we took note of the Adjusted R sqaured number and the best two regressor models in each fish species. 
