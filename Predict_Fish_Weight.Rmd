...
Using the above chart, we can see that the best two regressor models are Height and Weight. This model is the best for the Perch data, as well as for the two element model. 
